...
> 神明頁 76 尊、籤詩兩套籤系＋藥籤 330 首。slug 一律永久承諾。
...
- **神明頁**
  - 神明聖誕曆（2026-07-08 commit `19e8dcd` 上線；反思層/競品 
  - 神明頁 title 補國曆聖誕日（同 commit）：GSC 實測神明頁 CTR 僅 1
  - 神明 `sameAs` 補齊（2026-06-23，48→69/76，src/data/
- **籤詩與籤系**
  - /poems 樞紐 not-indexed 根因＝尾斜線分裂（2026-07-08 同 
  - `/systems/` 籤系樞紐頁（2026-08-01，同 commit）：原本各籤系
  - 保生大帝藥籤 330 首（2026-07-31）：臺南興濟宮版，大人科120／小兒科60
- **全站結構化標記**
  - speakable schema（2026-06-23 commit `365b78f`
