# 外部搜尋趨勢自動優化 brief｜folk.tw｜2026-08-22
...
- GSC 本站交叉證據：24 條目（2026-08-13..2026-08-19）

## 可進入自動內容優化佇列
### 1. 115年8月6日嘉義市南雲宮籤詩（分數 57｜refresh-existing-page）
...
### 2. 115年8月9日嘉義市南雲宮籤詩（分數 57｜refresh-existing-page）
- 訊號：／上升｜來源：Bing Webmaster。
- 對應頁面：[既有籤詩頁](https://folk.tw/poems/)。
- 為什麼進佇列：Bing Webmaster 查詢表現上升或首次出現；對應既有頁面「既有籤詩頁」。
- 安全自動化範圍：src/data/poems.json；只調整閱讀動線、入口或不含法規事實的文案。
