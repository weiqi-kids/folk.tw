# 外部搜尋趨勢自動優化 brief｜folk.tw｜2026-08-17
...
- GSC 本站交叉證據：24 條目（2026-08-08..2026-08-14）

## 可進入自動內容優化佇列
### 1. 廟宇求籤詩櫃（分數 65｜refresh-existing-page）
...
### 2. 2026年中元節 農曆七月十五 國曆日期（分數 61｜refresh-existing-page）
- 訊號：／上升｜來源：Bing Webmaster。
- 對應頁面：[既有節日頁](https://folk.tw/festivals/)。
- 為什麼進佇列：Bing Webmaster 查詢表現上升或首次出現；對應既有頁面「既有節日頁」。
- 安全自動化範圍：src/data/festivals.json；只調整閱讀動線、入口或不含法規事實的文案。
- 來源查證：來源查證、日期與站內搜尋意圖；任一項不成立就不自動發布；未找到官方來源就不寫，自動流程直接跳過。
- 來源連結：[Bing Webmaster](https://folk.tw/)。
